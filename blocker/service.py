#!/usr/bin/env python3
"""Explicit install/status/uninstall for the user-owned read-only schedule service."""
import argparse
import os
...
def main():
    ...
    if result.returncode:
        ...
        return result.returncode
    PLIST.unlink()
    print('Schedule service removed. Disable/remove the Chrome extension to clear cached blocks immediately.')
    return 0
